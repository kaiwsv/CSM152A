...
HD_PWD='C:/Users/Student/KaiEmanuel/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpcvt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpcvt.tcl
